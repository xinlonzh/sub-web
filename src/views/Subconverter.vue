              ...
              <div v-if="advanced === '2'">
                <el-form-item label="后端地址:">
                  <el-autocomplete
                    ...
                    placeholder="vhostss后端地址：http://api.090609.xyz:25500/sub?"
                  >
  ...
  data() {
    return {
      ...
      options: {
        ...
        backendOptions: [{ value: "http://api.090609.xyz:25500/sub?" }],
        remoteConfig: [
          {
            label: "universal",
            options: [
    ...
    notify() {
      ...
      this.$notify({
        ...
        message: h(
          "i",
          { style: "color: teal" },
          "各种订阅链接（短链接服务除外）生成纯前端实现，无隐私问题。默认使用vhostss提供的后端转换服务，隐私担忧者请自行搭建后端服务。"
        )
      });
    },
    confirmUploadConfig() {
